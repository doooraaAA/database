...
public class Users  {
    ...
    public Users(Integer id, String name, String pwd, String realname, String sex, Integer age, String card, String address, String phone, String email, String code, Integer type,String TableNo) {
        this.id = id;
        this.name = name;
        this.pwd = pwd;
        this.realname = realname;
    ...
    public Users(Integer id, String TableNo) {
        this.id = id;
        this.TableNo = TableNo;
    }
    ...
    public void setType(String TableNo) {
        this.TableNo = TableNo;
    }
