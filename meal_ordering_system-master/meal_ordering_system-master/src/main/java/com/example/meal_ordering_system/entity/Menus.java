...
public class Menus  {
    ...
    public Menus(Integer id, String name, Integer typeid, String burden, String brief, Float price, Integer sums, Float price1, Integer sums1, String imgpath,Integer status) {
        this.id = id;
        this.name = name;
        this.typeid = typeid;
        this.burden = burden;
