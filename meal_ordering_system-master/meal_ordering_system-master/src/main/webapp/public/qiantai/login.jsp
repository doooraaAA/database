          ...
          <div style="padding:0px">
            ...
            <div style="width:600px; height:210px;text-align:left;border:1px #f59d5e solid; background-color:#fdebd5;padding:30px;margin:0px">
              <div style="width:210px;float:left;text-align:left;border:1px #f59d5e solid;padding:20px;background-color:#ffffff;">
                <form name="form1" action="/users/login"
                      method="post" onSubmit="return login11()">
                <%//form method="post" action="/users/login"/>" name="form1" onSubmit="return login11()"%>
                  ...
                  <table width="100%"  border="0" cellspacing="0" cellpadding="3">
                    <%--tr>
                      ...
                      <tr>
                        <td>手机号</td>
                        <td><input type="text" id="mphone" name="phone" class="input"  style="width:135px" maxlength="20" /></td>
                      </tr>
                    <tr>
                      <td>登录密码</td>
              ...
              <div style="width:290px;padding:20px;float:right;text-align:left;border:1px #f59d5e solid;background-color:#ffffff;">
                <ul style="margin:0px;padding:0px">
                  ...
                  <%--i style="list-style-type: none;line-height:30px; background:url(images/cateitems.gif) left no-repeat;padding-left:20px"> 如果您忘记了密码， <a href="../member/lostpass.php" ><font color="#99CC00">点这里重设一个密码</font></a></--li--%>
                </ul>
              </div>
            </div>
          </div>
