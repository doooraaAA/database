...
<a href="/users/logout" target="_top">注销退出</a>|
...
<li ><a href="${pageContext.request.contextPath}/public/qiantai/center.jsp" target="_self">用户中心</a></li--%>
  <li ><a href="<c:url value="/users/checksessionorder"/>" target="_self">我的订单</a></li>
  <li ><a href="${pageContext.request.contextPath}/users/checksessioncenter" target="_self">用户中心</a></li>
