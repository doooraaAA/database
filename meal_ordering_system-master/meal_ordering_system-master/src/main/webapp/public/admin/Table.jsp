						...
						<tbody style="margin: 0; padding: 0">
							<tr>
								<td class="line_table" align="center" colspan="8" height="20">
									<span class="left_bt2">餐桌信息列表</span>
								</td>
							</tr>
							<tr>
								<td class="line_table" align="center" width="30%"><span
									class="left_bt2">餐桌号</span></td>
								<td class="line_table" align="center" width="30%"><span
									class="left_bt2">餐桌状态</span></td>
							...
							<tr>
								...
								<td class="line_table" align="center" width="20%"><a
										href="<c:url value="/Tables/updateStatusadmin?id=${t.id}"/>" target="main">修改状态</a></td>
								<td class="line_table" align="center" width="20%"><a
										href="<c:url value="/Tables/delete?id=${t.id}"/>" target="main">删除餐桌</a></td>
